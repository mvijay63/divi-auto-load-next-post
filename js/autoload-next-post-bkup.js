(function($) {
    ...
    function closeWidget() {
        ...
        // Show floating button and navigation buttons after widget closes
        setTimeout(function() {
    ...
    function updateReadingWidget() {
        if (!$readingWidget || !$floatingButton || !$goToTopButton || !$goToBottomButton) return;
        
        const scrollTop = $(window).scrollTop();
        const visiblePost = getPostInViewport();
        
        // After scrolling past 300px, close widget and show button
        if (scrollTop > 300 && isWidgetOpen) {
            closeWidget();
        }
    ...
    $(document).ready(function() {
        ...
        // Create reading widget and buttons
        createReadingWidget();
